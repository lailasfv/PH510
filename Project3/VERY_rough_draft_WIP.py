...
class Monte_Carlo:
    def __init__(self, starts, ends, N, func2, variables=[]):
        ...
        self.f = func2
        self.N = N
        self.variables = variables # if args are passed, assumed to be a variable array for function
    ...
    def infinity(self, seed):
        ...
        inf_ends = 1
        streams = Monte_Carlo.random(seed)
        points = streams[rank].random((self.N, dim)) #CONSIDER CHANGING to N/nworkers
        ...
        prefactor1 = 1  # this will be used to create the (b-a)(d-c)...
        prefactor2 = 1/(num_points*nworkers) #CONSIDER CHANGING to just num_points
        d = 0
        while d < dim:
            # we get our (b-a)(c-d...)
...
test_x_square = Monte_Carlo(a, b, num_points, test_vari, variables=vari)
